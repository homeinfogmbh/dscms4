...
def _list_customer_events() -> JSON:
    ...
    return JSON(
        [
            ...
            for customer_event in list_customer_events(
...
def add_customer_event() -> JSONMessage:
    ...
    customer_event.save()
    return JSONMessage("Customer event added.", id=customer_event.id, status=201)
...
def list_deployment_memberships() -> JSON:
    ...
    return JSON([dce.to_json() for dce in get_deployment_customer_events(CUSTOMER.id)])
...
def list_group_memberships() -> JSON:
    ...
    return JSON([gce.to_json() for gce in get_group_customer_events(CUSTOMER.id)])
...
def list_user_memberships() -> JSON:
    ...
    return JSON([uce.to_json() for uce in get_user_customer_events(CUSTOMER.id)])
...
ROUTES = [
    ...
    ("GET", "/tenantcalendar/membership/deployment", list_deployment_memberships),
    ...
    ("POST", "/tenantcalendar/membership/deployment", add_deployment_membership),
    ...
    (
        "DELETE",
        "/tenantcalendar/membership/deployment/<int:ident>",
        remove_deployment_membership,
    ),
    ("DELETE", "/tenantcalendar/membership/group/<int:ident>", remove_group_membership),
    ("DELETE", "/tenantcalendar/membership/user/<int:ident>", remove_user_membership),
]
